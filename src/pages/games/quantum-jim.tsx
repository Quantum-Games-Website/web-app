      ...
      <div className="z-0 min-h-screen  flex-1 bg-[url('/assets/images/background.png')] bg-[length:400px_500px] bg-repeat text-2xl font-semibold ">
        ...
        <div className="container my-12 mx-auto   px-4 md:px-12">
          ...
          <p className="text-gray-600">
            {' '}
            {
              'Help Quantum Jim save Quantum Princess by solving quantum computing puzzles. Seek help from other NPCs to help you find your next clue. Fight the Quantbots! Quantum Princess is waiting for you'
            }
          </p>
        </div>
      </div>
